...
<div class="w3-bar w3-white w3-border-bottom w3-xlarge">
  <a href="#" class="w3-bar-item w3-button w3-text-red w3-hover-red"><b><i class="fa fa-map-marker w3-margin-right"></i>TRAVEL</b></a>
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <p class="w3-opacity">Roundtrip from 6,278</p>
        <p></p>
    ...
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <p class="w3-opacity">One-way from 3096</p>
        <p></p>
        <button class="w3-button w3-margin-bottom">Buy Tickets</button>
      </div>
    </div>
  ...
  <div class="w3-container">
    ...
    <i class="fa fa-map-marker" style="width:30px"></i> Bhandara , India<br>
    <i class="fa fa-phone" style="width:30px"></i> Phone: 9823360388<br>
    <i class="fa fa-envelope" style="width:30px"> </i> Email: kajalborkar48@mail.com<br>
...
<footer class="w3-container w3-center w3-opacity w3-margin-bottom">
  ...
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank" class="w3-hover-text-green">kajal_borkar</a></p>
</footer>
